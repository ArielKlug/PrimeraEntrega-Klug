          ...
          <Menu closeOnSelect={false}>
            ...
            <MenuList>
              <MenuOptionGroup title="Filtro" type="checkbox">
                <MenuItemOption value="hProcesador">Procesador</MenuItemOption>
                <MenuItemOption value="Placa video">placa videos</MenuItemOption>
                <MenuItemOption value="ram">ram</MenuItemOption>
